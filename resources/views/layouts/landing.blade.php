        ...
        <section class="section-base section-bottom-layer">
            <div class="container">
                <ul class="slider" data-options="type:carousel,arrows:false,nav:false,perView:5,perViewMd:3,perViewSm:2,perViewXs:1,gap:50,autoplay:3000">
                    <li>
                        <img src="{{asset('assets/images/logo-1.png')}}" style="min-width: 150px" alt="" />
                    </li>
                    <li>
...
{{--   
        <section class="section-image align-center light frontendSection" style="background-image:url({{asset('assets/images/bg.svg')}})">
            <div class="container">
                <h2>การพัฒนา Responsive เว็บไซต์</h2>
                <p class="width-900">
                    Responsive เป็นเทคนิคการออกแบบเว็บไซต์ให้มีการแสดงผลได้อย่างสวยงาม เหมาะสมกับขนาดหน้าจอ, แพลทฟอร์ม หรือมุมมองการแสดงผล (แนวตั้งหรือแนวนอน) ผ่านการใช้คำสั่ง CSS ด้วยเทคนิคต่าง ๆ เช่น Flex, Grid, และ CSS Media Queries ที่นี่เราจะสอนออกแบบ Responsive เว็บไซต์ด้วยคำสั่ง css ที่ง่ายและใช้บ่อย นอกจากนี้การใช้ Effect ต่าง ๆ เพื่อให้เว็บไซต์มีลูกเล่นน่าสนใจสไตล์โมเดิร์นเว็บไซต์
                </p>
