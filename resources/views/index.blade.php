            ...
            <div class="col-lg-12">
                ...
                {{-- <form class="form-box form-ajax boxed-area paymentForm" action="{{route('getCharge')}}" method="POST" > --}}
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <p>ชื่อ</p>
                            <input id="name" name="name" placeholder="ชื่อ" type="text" class="input-text" required value="โปรแกรม">
                        </div>
                        <div class="col-lg-6">
                            <p>นามสกุล</p>
                        ...
                        <div class="col-lg-6">
                            <p>โทรศัพท์</p>
                            <input id="phone" name="phone" placeholder="โทรศัพท์" type="text" class="input-text" required value="0882541254">
                        </div>
                        <div class="col-lg-12">
                            <p>ที่อยู่</p>
                            <textarea id="address" name="address" class="input-textarea" placeholder="ที่อยู่">105 หมู่ที่ 8 ต.เหมืองง่า อ.เมือง จ.ลำพูน 51000</textarea>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <p>บริษัท (ถ้ามี)</p>
                            <input id="company" name="company" placeholder="บริษัท" type="text" class="input-text" value="" >
                        </div>
                        <div class="col-lg-6">
