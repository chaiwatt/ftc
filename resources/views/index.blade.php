            ...
            <div class="col-lg-12">
                ...
                {{-- <form class="form-box form-ajax boxed-area paymentForm" action="{{route('getCharge')}}" method="POST" > --}}
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <p>ชื่อ</p>
                            <input id="name" name="name" placeholder="ชื่อ" type="text" class="input-text" required value="ฟ้าใส">
                        </div>
                        <div class="col-lg-6">
                            <p>นามสกุล</p>
                        ...
                        <div class="col-lg-6">
                            <p>โทรศัพท์</p>
                            <input id="phone" name="phone" placeholder="โทรศัพท์" type="text" class="input-text" required value="0882514254">
                        </div>
                        <div class="col-lg-12">
                            <p>ที่อยู่</p>
